...
execute if score @s bgui.iteration matches 0 run function barden.guimaker:commands/allguilist/search_from_username/__3__
execute if score @s bgui.iteration matches 1.. run function barden.guimaker:commands/allguilist/search_from_username/__2__ with storage minecraft:barden.gui.list.query Query[0]