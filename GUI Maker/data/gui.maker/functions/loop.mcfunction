...
#> teleport chest_minecart
     ...
     execute as @e[type=chest_minecart,tag=gm.gui.ui] if score @s gm.Linking = @p gm.Linking as @p at @s anchored eyes positioned ^ ^ ^0.1 run tp @e[sort=nearest,limit=1,tag=bgui.gui-true] ~ ~-0.05 ~
