...
execute if score $GUIS_OWNED gm.Values matches 0 run function gui.maker:maker/gui/add_page/list/no_entry with storage barden:names Names
...
execute if score $GUIS_OWNED gm.Values matches 1.. run function gui.maker:maker/gui/add_page/list/2 with storage barden:temp list[0]
tellraw @s {"text":"-------------------------------","color":"#FFDF8D"}
