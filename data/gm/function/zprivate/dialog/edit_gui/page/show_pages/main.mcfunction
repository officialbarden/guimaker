...
$function gm:zprivate/dialog/edit_gui/list/invert_list {GUI_ID:$(GUI_ID)}
...
function gm:zprivate/dialog/edit_gui/page/show_pages/format with storage gm:storage temp.DIALOG.list.MAIN[0]

# // past barden: show dialog of all pages in the GUI:
function gm:zprivate/dialog/edit_gui/page/show_pages/show with storage gm:storage temp.DIALOG.list
