...
$data modify storage gm:storage GUI[{GUI_ID:$(GUI_ID)}].PAGES[-1].PAGE_CONTENTS[].components."minecraft:custom_data".gui set value {item:"simple_button",execute:{function:"",item_modifier:"",command:""}}
