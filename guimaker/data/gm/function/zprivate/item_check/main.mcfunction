...
# Chest Minecart
    execute as @s[tag=_gui.chestminecart,type=marker] at @s on vehicle if entity @s[type=chest_minecart] on passengers as @s[type=marker,tag=_gui.chestminecart] store success score @s gm.Tests run data modify entity @s data.Items set from block ~ ~ ~ Items
